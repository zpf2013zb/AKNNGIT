...
unsigned long long printPageAccess(int num)
{
	...
	//int page = DATA_PAGE_ACCESS + INDEX_PAGE_ACCESS + SEQ_PAGE_ACCESS + RAN_PAGE_ACCESS;

	unsigned long long temp = (unsigned long long)DATA_PAGE_ACCESS;
	if (num>0) {
		DATA_PAGE_ACCESS = 0;
		INDEX_PAGE_ACCESS = 0;
		SEQ_PAGE_ACCESS = 0;
