...
public:
    ...
    static std::vector<unsigned long long> getKeywords(std::size_t totalNumberOfNodes,std::size_t avgKeywords, std::vector<unsigned long long>& keys);
	...
	static int getNumOfPoints(int aveNPt);
private:
	// do nothing
    KeywordsGenerator();
	// do nothing 
